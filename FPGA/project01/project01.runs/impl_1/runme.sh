...
HD_PWD='C:/Users/WPT_Bench/Documents/matsumoto/pe-expert4_git/ipfpga/IPFPGA-peak_hold_for_pid/IPFPGA-sample.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mwpe4_ipfpga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mwpe4_ipfpga_top.tcl -notrace
