...
HD_PWD='C:/Users/WPT_Bench/Documents/matsumoto/pe-expert4_git/ipfpga/IPFPGA-peak_hold_for_pid/IPFPGA-sample.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mwpe4_ipfpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mwpe4_ipfpga_top.tcl
